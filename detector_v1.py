...
class TestPatternDetector:
    ...
    def generate_csv_report(self):
        ...
        with open(csv_path, 'w', newline='') as csvfile:
            # UPDATED: Changed "Total Runs" to "Failed/Total Runs"
            fieldnames = [
            ...
            for pattern in sorted_patterns:
                ...
                # UPDATED: Show "fail_count/total_runs" format (e.g., "3/15")
                writer.writerow({
    ...
    def generate_html_dashboard(self):
        ...
        for pattern in self.test_patterns.values():
            if pattern.classification == 'Flaky':
                flaky_tests.append({
                    'name': pattern.test_name.split('.')[-1][:30],
                    'rate': pattern.failure_rate
                })
            elif pattern.classification == 'Consistently Failing':
...
<head>
    ...
    <title>Test Pattern Detection Dashboard</title>
...
<body>
    <div class="container">
        ...
        <div class="table-container">
            <h3>🚨 Critical Tests Requiring Attention</h3>
            <table>
                <thead>
                    <tr>
                        <th>Test Name</th>
...
"""
        ...
        for pattern in critical_tests:
            ...
            html_content += f"""
                    <tr>
                        <td>{pattern.test_name.split('.')[-1][:50]}</td>
...
"""
        ...
        <div class="footer">
            <p><strong>Test Pattern Detector v1.1</strong> | Optisol Business Solutions</p>
            <p>Developed by Muji - DevSecOps Team</p>
        </div>
    </div>
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description='Test Pattern Detection Tool - Identify flaky and failing tests automatically'
    )
    parser.add_argument(
        '--input',
        nargs='+',
    ...
    # Print banner
    print("=" * 70)
    print("  TEST PATTERN DETECTION TOOL")
    print("  Automated Flaky & Failed Test Analysis")
    print("  Version 1.1.0 | Optisol Business Solutions")
    print("=" * 70)
    print()
    ...
    print("\n  ✨ Analysis complete! Open dashboard.html to view detailed results.\n")
